...
//         fill: true,
//         tension: 0.3,
//         backgroundColor: (context): string => getGradient(context, [25, 74, 80], 250),
//         borderColor: "#194a50",
...
//         fill: true,
//         tension: 0.3,
//         backgroundColor: (context): string => getGradient(context, [206, 90, 159], 150),
//         borderColor: "#ce5a9f",
...
//         fill: true,
//         tension: 0.3,
//         backgroundColor: (context): string => getGradient(context, [216, 178, 110], 150),
//         borderColor: "#d8b26e",
...
export const EventsPerDay: React.FC = () => {
  ...
  return (
    <BlockChart
      header={<Heading as="h3">Events Per Day</Heading>}
      controlsLeft={
        <Button

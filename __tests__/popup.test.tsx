...
it("renders the component children inside popupContent", () => {
  const { queryByTestId } = render(<Popup children={<div className="test-child"></div>} />)
...
it("doesn't show close button if showCloseButton is false", () => {
  const { queryByTestId } = render(<Popup showCloseButton={false} children={<div className="test-child"></div>} />)
